...
const u16 gClassBasedTrainerEncounterBGM[NUM_TRAINER_CLASSES] =
{
	...
	[CLASS_TEAM_ROCKET] = BGM_EYE_DUSK,
	...
	[CLASS_COOLTRAINER_RS] = BGM_EYE_ACETRAINER,
	[CLASS_HIKER_RS] = BGM_EYE_HIKER,
	[CLASS_INTERVIEWER] = BGM_EYE_GENTLEMAN,
};
#endif

const u16 gClassBasedBattleBGM[NUM_TRAINER_CLASSES] =
{
	[CLASS_TEAM_ROCKET] = BGM_BATTLE_DUSK,
	[CLASS_AQUA_ADMIN] = BGM_BATTLE_DUSK,
	[CLASS_CHAMPION] = BGM_BATTLE_CHAMPION,
	[CLASS_LEADER] = BGM_BATTLE_GYM_LEADER,
	[CLASS_ELITE_4] = BGM_BATTLE_RSE_GYM_LEADER,
	[CLASS_RIVAL] = BGM_BATTLE_RSE_TRAINER,
	[CLASS_AROMA_LADY_RS] = BGM_BATTLE_WORLD_CHAMPION,
};
...
const u16 gWildSpeciesBasedBattleBGM[] =
{
	...
	[SPECIES_HO_OH] = BGM_BATTLE_MEWTWO,
...
const u16 gClassBasedTrainerEncounterBGM[NUM_TRAINER_CLASSES] =
{
	...
	[CLASS_BLACK_EMBOAR] = BGM_EYE_BLACK_BELT,
	...
	[CLASS_SCIENCE_SOCIETY] = BGM_EYE_MYSTERIOUS,
	//[CLASS_BOSS] =
	//[CLASS_LEADER] =
...
const u16 gWildSpeciesBasedBattleBGM[] =
{
	...
	[SPECIES_HOOPA] = BGM_BATTLE_KALOS_LEGENDARY,
	[SPECIES_HOOPA_UNBOUND] = BGM_BATTLE_KALOS_LEGENDARY,
...
const u16 gRandomBattleMusicOptions[] =
{
	...
	BGM_BATTLE_BLACK_HORIZON_ADMIN,
